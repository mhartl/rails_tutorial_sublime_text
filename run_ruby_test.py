...
class ShowInPanel:
  ...
  def display_results(self):
    ...
    self.panel.settings().set("color_scheme", "Packages/User/CustomTestConsole.tmTheme")
...
class ShowInScratch:
  ...
  def display_results(self):
    ...
    self.view.settings().set("color_scheme", "Packages/User/CustomTestConsole.tmTheme")
